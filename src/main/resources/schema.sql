...
create table product_category(
  ...
  primary key (id),
  foreign key (category_parent) references product_category(id)
);
...
insert into product_category(id, name, category_parent) values (11, 'TOP', 10);
insert into product_category(id, name, category_parent) values (12, 'PANTS', 10);
insert into product_category(id, name, category_parent) values (13, 'OUTER', 10);
insert into product_category(id, name, category_parent) values (14, 'SHOES', 10);
insert into product_category(id, name, category_parent) values (15, 'BAG', 10);
insert into product_category(id, name, category_parent) values (16, 'ACCESSORY', 10);
insert into product_category(id, name, category_parent) values (17, 'UNDERWEAR', 10);
insert into product_category(id, name, category_parent) values (18, 'NEW_ARRIVAL', 10);
